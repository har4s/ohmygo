...
func TestNewNotFoundError(t *testing.T) {
	...
	for i, scenario := range scenarios {
		e := api.NewNotFoundError(scenario.message, scenario.data)
		result, _ := json.Marshal(e)
...
func TestNewBadRequestError(t *testing.T) {
	...
	for i, scenario := range scenarios {
		e := api.NewBadRequestError(scenario.message, scenario.data)
		result, _ := json.Marshal(e)
...
func TestNewForbiddenError(t *testing.T) {
	...
	for i, scenario := range scenarios {
		e := api.NewForbiddenError(scenario.message, scenario.data)
		result, _ := json.Marshal(e)
...
func TestNewUnauthorizedError(t *testing.T) {
	...
	for i, scenario := range scenarios {
		e := api.NewUnauthorizedError(scenario.message, scenario.data)
		result, _ := json.Marshal(e)
